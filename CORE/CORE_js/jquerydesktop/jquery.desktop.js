	...
	return {
		...
		init_desktop: function() {
			...
			$(this).css("top",((80*i+1)+20)+'px');
				...
				// direct link
				if (linkType==1){$(this).attr('href',link)}
			...
			var linkType =  $(this).attr('rel');
			//alert(" 1:" + linkType + " 2:" + ajaxEnabled)
			if ((linkType==0 && ajaxEnabled) || linkType==2) e.preventDefault(); 
