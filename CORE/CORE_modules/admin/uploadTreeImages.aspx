...
<script runat="server">
    ...
    Sub page_load()
        ...
        Try
            ...
            Dim idTree As Integer = Request("idTree")
            Dim myFile As HttpPostedFile = Request.Files("Filedata")
            Dim contentFolder As String = ConfigurationManager.AppSettings("CORE_tree_folder").ToString()
            ...
            myupload.file_name = idTree.ToString() & ".jpg"
