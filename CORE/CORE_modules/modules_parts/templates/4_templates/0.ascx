...
<ItemTemplate>
<a href="<%#core.makeLink(CORE.MyPage(Me).root_mypage.rootPath,CType(CType(Container, RepeaterItem).DataItem, CORE_CONTEXT).id_key,CType(CType(Container, RepeaterItem).DataItem, CORE_CONTEXT).context_title,CORE.pageEvent.searchByTags) %>"><span><%#CType(CType(Container, RepeaterItem).DataItem, CORE_CONTEXT).context_title%></span></a>
</ItemTemplate>
<SeparatorTemplate><span>,</span></SeparatorTemplate>
