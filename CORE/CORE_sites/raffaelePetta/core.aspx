...
Sub Page_load()
        ...
        Dim age As TimeSpan = TimeSpan.FromDays(7)
      
        ' Me.Response.Cache.SetMaxAge(age)
        ...
        If root_mypage.id_content > 0 Then ltTokenC.Text = CORE_CRYPTOGRAPHY.encrypt(root_mypage.id_content) Else ltTokenC.Text = 0
        ...
        'ltScripts.Text = CORE.pageScripts(root_mypage)
...
<!--<asp:Literal ID="ltScripts" runat="server" EnableViewState="false" />-->
...
<div id="menuBtn" onclick="openNavMenu();"></div>
