...
<a href="#" id="refresh" onClick="javascript:loadNext();"><img src="/core/core_sites/defaultSite/_css/_it/_deluca/_images/icon-refresh-128.png" /></a>
</header>
...
<div id="parallaxcontainer" class="parallaxcontainer">
		<div id="parallaxscene" class="parallaxscene">
            ...
            <div class="layer" id="parallax-mountains" data-depth="0.10"></div>
			<div class="layer" id="parallax-city"  data-depth="0.25"></div>
            <div class="layer" id="parallax-say"  data-depth="0.05">  <p id="deluca">Loading...</p></div>
          	<div class="layer" id="parallax-penguins"  data-depth="0"></div>
			<div class="layer" id="parallax-rocks" data-depth="1"></div>
            <div class="layer" id="parallax-deluca" data-depth="0"></div>
		</div>
</div>
...
<div id="footer">
<a href='http://www.zero89.it' id='core' title='Powered with CORE' target='_blank'><span>Tap/click the penguins!!!</span></a>
</div>
</div>
</div>
</div>
