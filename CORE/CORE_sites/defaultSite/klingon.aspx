...
<a href="#" id="refresh" onClick="javascript:loadNext();"><img src="/core/core_sites/defaultSite/_css/_it/_klingon/_images/backgrounds/klingon-logo.png" /></a>
</header>
<div id="klingon-container"><img src="/core/core_sites/defaultSite/_css/_it/_klingon/_images/backgrounds/klingonNew.gif" /></div>
<p id="klingon">Loading...</p>
</div>

<div id="footer">
<a href='http://www.zero89.it' id='core' title='Powered with CORE' target='_blank'><span>Powered with CORE</span></a>
</div>
</div>
</div>
