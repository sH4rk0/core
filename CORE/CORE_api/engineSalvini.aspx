...
<script runat="server">
    ...
    Sub page_load()
        ...
        doc.Load(Server.MapPath("/core/core_xml/salvini.xml"))
        Dim nodes As XmlNodeList = doc.SelectNodes("root/salvini")
        Randomize()
        ...
        Catch err As Exception
            ...
            returnData("<values><error errorId=""666"" errorLabel=""Damn Error!"" errorMsg=""" & Server.HtmlEncode(err.ToString()) & """/></values>")
